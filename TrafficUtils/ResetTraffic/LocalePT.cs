    ...
    public class LocalePT : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.ResetModSettings)), "Restaura filtros de tipo, controles de ritmo e debugging aos valores originais. Não remove tráfego." },
                { m_Setting.GetOptionWarningLocaleID(nameof(Setting.ResetModSettings)), "Restaurar filtros de tipo, controles de ritmo e debugging aos valores padrão? Isso não remove tráfego." },
