    ...
    public class LocaleRU : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.ResetModSettings)), "Восстанавливает фильтры типов, ползунки темпа и отладку к исходным значениям. Не удаляет транспорт." },
                { m_Setting.GetOptionWarningLocaleID(nameof(Setting.ResetModSettings)), "Восстановить фильтры типов, ползунки темпа и отладку к значениям по умолчанию? Это не удаляет транспорт." },
