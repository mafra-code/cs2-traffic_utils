    ...
    public class LocaleFR : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.ResetModSettings)), "Restaure les filtres de type, les curseurs de rythme et le debugging à leurs valeurs d'origine. Ne retire pas de trafic." },
                { m_Setting.GetOptionWarningLocaleID(nameof(Setting.ResetModSettings)), "Restaurer les filtres de type, les curseurs de rythme et le debugging aux valeurs par défaut ? Cela ne retire pas de trafic." },
