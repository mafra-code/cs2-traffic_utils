    ...
    public class LocalePL : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.ResetModSettings)), "Przywraca filtry typów, suwaki tempa i debugging do oryginalnych wartości. Nie usuwa ruchu." },
                { m_Setting.GetOptionWarningLocaleID(nameof(Setting.ResetModSettings)), "Przywrócić filtry typów, suwaki tempa i debugging do wartości domyślnych? To nie usuwa ruchu." },
